...
gestorMenu.addPlugin("leaflet","https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.4.0/leaflet.js", function() {
	...
	gestorMenu.addPlugin("ZoomHome","templates/argenmap-leaflet-bahra-tpl/js/leaflet-zoomhome/dist/leaflet.zoomhome.min.js");
	// Leaflet Bing Layer
	gestorMenu.addPlugin("BingLayer","templates/argenmap-leaflet-bahra-tpl/js/leaflet-bing-layer-gh-pages/leaflet-bing-layer.js");
	// <!-- Leaflet Minimap plugin -->
	gestorMenu.addPlugin("minimap","templates/argenmap-leaflet-bahra-tpl/js/leaflet-minimap/Control.MiniMap.js");
	// <!-- Leaflet Locate plugin -->
	gestorMenu.addPlugin("locate","templates/argenmap-leaflet-bahra-tpl/js/leaflet-locate/L.Control.Locate.min.js");
	// <!-- Leaflet Mouse Position plugin -->
	gestorMenu.addPlugin("MousePosition","templates/argenmap-leaflet-bahra-tpl/js/leaflet-mouseposition/src/L.Control.MousePosition.js");
	// <!-- Leaflet Measure plugin --> 
	gestorMenu.addPlugin("Measure","templates/argenmap-leaflet-bahra-tpl/js/leaflet-measure/leaflet-measure.js");
	// <!-- Leaflet BrowserPrint plugin -->
	gestorMenu.addPlugin("BrowserPrint","templates/argenmap-leaflet-bahra-tpl/js/leaflet-browser-print/dist/leaflet.browser.print.min.js");
	// <!-- Leaflet Control.FullScreen plugin -->
	gestorMenu.addPlugin("FullScreen","templates/argenmap-leaflet-bahra-tpl/js/leaflet-fullscreen/Control.FullScreen.js");
	// <!-- Leaflet BetterWMS -->
	gestorMenu.addPlugin("betterWMS","templates/argenmap-leaflet-bahra-tpl/js/leaflet-wms/leaflet.wms.js");
	// <!-- Leaflet Draw -->  
	gestorMenu.addPlugin("Draw","https://cdnjs.cloudflare.com/ajax/libs/leaflet.draw/1.0.4/leaflet.draw.js")
	// <!-- Leaflet SimpleGraticule -->
	gestorMenu.addPlugin("graticula","templates/argenmap-leaflet-bahra-tpl/js/leaflet-simplegraticule/L.SimpleGraticule.js");
});
			...
			switch (e) {
				...
				case 'BrowserPrint':
					...
					L.control.browserPrint({
                        ...
                        printLayer: L.tileLayer('http://wms.ign.gob.ar/geoserver/gwc/service/tms/1.0.0/capabaseargenmap@EPSG%3A3857@png/{z}/{x}/{y}.png', {
                                        tms: true,
                                        maxZoom: 21,
                                        attribution: atrib_ign
                                    }),
...
function showMainMenuTpl() {
	...
	gestorMenu.setShowSearcher(false);
    gestorMenu.print();
}
